...
| 1.0.0-rc.4 | 批 0–5 通过；批 6 ZIP 带 `kmod/*.ko`，`check` 写 vermagic | `docs/plan/rc4.md`；§0.6.32–0.6.45。S6 为本机 dst 投递。默认 `FLUXRS_STAGE=6` `FLUXRS_NOCFI=1`。`dataplane::Manager` 加载 `.ko`；取消勾选拆活 TCP；信封含 GKI 代模块 |
