...
| 1.0.0-rc.3 设计 | 批 0–5 已落地（合同、TrustedSnapshot、开关三态、WatchSet、ProbeReady、PolicyEpoch 双 bank、Planner Commands、EngineSpec cwd、CLI 退出码、订阅批次预算、typed map）；批 6 未做 | `docs/plan/rc3.md` |
